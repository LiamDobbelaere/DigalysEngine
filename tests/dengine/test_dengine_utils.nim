...
suite "DEngine utils":
  ...
  test "toFloat32(bytes)":
    ...
    const testValue: array[4, uint8] = [174'u8, 71, 177, 64]
  ...
  test "toBytes(float32)":
    ...
    doAssert testValue.toBytes == [174'u8, 71, 177, 64], "should explode a float32 into its byte components"

  test "toInt32(bytes)":
    # 123456789 = 21, 205, 91, 7 in little-endian
    const testValue: array[4, uint8] = [21'u8, 205, 91, 7]
  ...
  test "toBytes(int32)":
    ...
    doAssert testValue.toBytes == [21'u8, 205, 91, 7], "should explode an int32 into its byte components"
